 ...
 */
@Slf4j
public abstract class AliYunRocketMQListener implements MessageListenerConcurrently {
    ...
    public AliYunRocketMQListener(IdempotentConfig config, Idempotent idempotent) {
//        this.strategy = strategy;
    ...
    public AliYunRocketMQListener(Idempotent idempotent) {
